...
_C.MODEL.NAME = "basic"
_C.MODEL.DOWNLOAD_PRETRAINED = False
...
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST_LOW = 0
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST_LOW = 0
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST_MEDIUM = 0
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST_MEDIUM = 0
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST_HIGH = 0
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST_HIGH = 0
# Values to be used for image normalization
_C.INPUT.PIXEL_MEAN = [0.5, 0.5, 0.5]
# Values to be used for image normalization
_C.INPUT.PIXEL_STD = [0.5, 0.5, 0.5]
# Values to be used for image normalization for grayscale imgs
_C.INPUT.PIXEL_MEAN_G = [0.5,]
# Values to be used for image normalization for grayscale imgs
_C.INPUT.PIXEL_STD_G = [0.5,]
# Values to be used for image normalization for ab channels
_C.INPUT.PIXEL_MEAN_L = [0.5,0.5]
# Values to be used for image normalization for ab channels
_C.INPUT.PIXEL_STD_L = [0.5,0.5]
...
#Image Cropping
_C.INPUT.CROPPING = False
_C.INPUT.CROPPING_MIN = 700
_C.INPUT.CROPPING_MAX = 1300
...
_C.SOLVER.MAX_ITER_EPOCH = 0

#Currently only L1 and L2
_C.SOLVER.LOSS = 'L2'
...
#Save every ... epoch ( can be 0)
_C.SOLVER.CHECKPOINT_PERIOD_EPOCH = 2
#At every ... iteration we should validate. negative integers for every -... epoch
...
_C.TEST.SAVE_SAMPLE_IMGS = False
_C.TEST.SAMPLE_IMGS_PATH = 'predictions'
